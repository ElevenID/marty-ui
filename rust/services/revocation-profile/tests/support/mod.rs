use marty_revocation_profile::organization_proto::{
    ...
    RemoveMemberResponse, UpdateMemberRequest, UpdateOrganizationRequest, ValidateApiKeyRequest,
...
pub const TOKEN: &str = "revocation-runtime-contract-token-2026";
...
pub async fn start_organization_server(
    member_exists: bool,
    permissions: Vec<String>,
