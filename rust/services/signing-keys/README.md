...
probes. Later slices move registry persistence, certificate/JWKS/DID
...
The `/internal/kms/*` and `/internal/config/validate` routes are
service-to-service compatibility endpoints.
