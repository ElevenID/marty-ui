...
fn baseline(environment: &str) -> BTreeMap<String, String> {
    BTreeMap::from([
        ...
        (
            "ORGANIZATION_GRPC_TARGET".into(),
            "organization:9002".into(),
        ),
        ...
        ("ISSUANCE_INTERNAL_API_KEY".into(), "i".repeat(32)),
    ])
}
