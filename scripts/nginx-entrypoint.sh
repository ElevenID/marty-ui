...
export PUBLIC_DOMAIN UI_DEV_PORT DOCS_DOMAIN GATEWAY_UPSTREAM CANVAS_REAL_PUBLIC_HOST CANVAS_SANDBOX_PUBLIC_HOST NORTHSTAR_ADMISSIONS_PUBLIC_HOST
...
echo "  NORTHSTAR_ADMISSIONS_PUBLIC_HOST: ${NORTHSTAR_ADMISSIONS_PUBLIC_HOST}"

# Substitute environment variables in template
envsubst '${PUBLIC_DOMAIN} ${UI_DEV_PORT} ${DOCS_DOMAIN} ${GATEWAY_UPSTREAM} ${CORS_ALLOWED_ORIGIN} ${CANVAS_REAL_PUBLIC_HOST} ${CANVAS_SANDBOX_PUBLIC_HOST} ${NORTHSTAR_ADMISSIONS_PUBLIC_HOST}' \
