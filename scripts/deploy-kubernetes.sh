...
cmd_setup_secrets() {
  ...
  local issuance_api_key grpc_service_token notification_webhook_secret notification_event_ingest_token integration_secret_master_key canvas_credentials_shared_secret openbao_service_token
