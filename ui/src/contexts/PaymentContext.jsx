...
const PaymentContext = createContext(defaultContextValue);
...
export function PaymentProvider({ children }) {
  ...
  const isMockMode = useMemo(() => {
    ...
    // Only use mock if explicitly enabled - not by default
    return envMock === 'true' || envMock === true;
  }, []);
