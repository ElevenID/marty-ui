...
export const TrustServiceMethods = {
   ...
   * @returns {Promise<import('./types').TrustProfile>}
   */
  updateTrustConfig: async (_orgId, _config) => {},
   ...
   */
  uploadBYOKCertificates: async (_orgId, _certificates) => {},
   ...
   */
  generateKey: async (_orgId, _options) => {},
   ...
   */
  testKeyConnection: async (_orgId, _keyConfig) => {},
