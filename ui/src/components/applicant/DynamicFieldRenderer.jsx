 ...
 */
function BooleanFieldRenderer({ field, value, onChange, error, required }) { // eslint-disable-line no-unused-vars
  return (
    <FormControlLabel
      control={
        <Checkbox
 ...
 */
function FileFieldRenderer({ field, value, onChange, error, required, fileInputRef }) { // eslint-disable-line no-unused-vars
