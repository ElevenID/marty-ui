...
_AUTH_ASSET_DIR = Path(__file__).resolve().parents[2] / "assets"
_CREDENTIAL_LOGIN_CSS = (_AUTH_ASSET_DIR / "credential-login.css").read_text(encoding="utf-8")


_CREDENTIAL_LOGIN_JS = (_AUTH_ASSET_DIR / "credential-login.js").read_text(encoding="utf-8")


_CREDENTIAL_LOGIN_PAGE = (_AUTH_ASSET_DIR / "credential-login.html").read_text(encoding="utf-8")


_CREDENTIAL_LOGIN_ERROR_PAGE = (
    _AUTH_ASSET_DIR / "credential-login-error.html"
