#!/usr/bin/env python3
"""
CLI tool for managing Alembic migrations for presentation-policy service.
...
SERVICE_NAME = "presentation_policy"  # Underscore format for schema name


def main():
    parser = argparse.ArgumentParser(description="Manage Alembic migrations for presentation-policy service")
