"""Add PolicySet RBAC permissions.
...
RESOURCE = "policy-set"
PERMISSIONS = [
    ("view", "View Cedar policy sets"),
    ("create", "Create Cedar policy sets"),
    ("edit", "Edit Cedar policy sets"),
    ("delete", "Delete Cedar policy sets"),
    ("activate", "Activate Cedar policy sets"),
    ("archive", "Archive Cedar policy sets"),
    ("validate", "Validate Cedar policy sets"),
]
ROLE_ACTIONS = {
    "owner": {"view", "create", "edit", "delete", "activate", "archive", "validate"},
    "admin": {"view", "create", "edit", "delete", "activate", "archive", "validate"},
    "access_admin": {"view", "create", "edit", "delete", "activate", "archive", "validate"},
    "catalog_admin": {"view", "create", "edit", "delete", "activate", "archive", "validate"},
    "viewer": {"view"},
}
