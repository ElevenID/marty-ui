...
deployment_profiles = Table(
    ...
    Column("default_trust_profile_id", String(36), nullable=True),
    Column("default_compliance_profile_id", String(36), nullable=True),
    Column("default_presentation_policy_id", String(36), nullable=True),
    ...
    Column("ux_config", JSON, nullable=False, default=dict),
